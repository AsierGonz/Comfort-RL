...
public class prueba2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!isSleeping)
        {
            ...
            //ArticulationReducedSpace jointConfig = new ArticulationReducedSpace(targetAngle + 50 * Mathf.Deg2Rad);
            //this.joint.jointPosition = jointConfig;

            StartCoroutine(SleepForSeconds(0.1f)); // Start the sleep coroutine for 3 seconds
        }
    }
